...
1. **定义决策变量及单位**：定义决策变量及单位  
   输入：-；输出：-；证据：E-TEXT-P005-735af443b8。
2. **写出目标函数**：写出目标函数  
   输入：-；输出：-；证据：E-TEXT-P005-735af443b8。
...
- [[基于蚁群算法与遗传算法优化的蒙特卡洛模拟在生产决策优化中的应用研究]]：证据 E-TEXT-P005-735af443b8

## 当前论文证据

> [!quote] E-TEXT-P005-735af443b8 · p.5 · 基于蚁群算法与遗传算法优化的蒙特卡洛模拟在生产决策优化中的应用研究
