...
1. **定义原假设与备择假设**：定义原假设与备择假设  
   输入：-；输出：-；证据：E-TEXT-P006-3b20b66b18。
...
- [[基于蚁群算法与遗传算法优化的蒙特卡洛模拟在生产决策优化中的应用研究]]：证据 E-TEXT-P006-3b20b66b18

## 当前论文证据

> [!quote] E-TEXT-P006-3b20b66b18 · p.6 · 基于蚁群算法与遗传算法优化的蒙特卡洛模拟在生产决策优化中的应用研究
